        ...
        static final class Natural implements ArgumentsProvider {
            ...
            public Stream<Arguments> provideArguments(ExtensionContext context) throws Exception {
                return Stream.of(
                        ...
                        arguments(new PitchWithoutOctave(Note.E, Accidental.SHARP), Scale.Major.Natural.B),
                        ...
                        arguments(new PitchWithoutOctave(Note.F, Accidental.SHARP), Scale.Major.Natural.F),
                        ...
                        arguments(new PitchWithoutOctave(Note.B, Optional.empty()), Scale.Major.Natural.F),
                        arguments(new PitchWithoutOctave(Note.C, Accidental.SHARP), Scale.Major.Natural.F),
                        arguments(new PitchWithoutOctave(Note.D, Optional.empty()), Scale.Major.Natural.F),
                        arguments(new PitchWithoutOctave(Note.E, Accidental.SHARP), Scale.Major.Natural.F),
